 ...
 * 
 * @property bool $min Adds a grayscale effect to an element (grayscale: 50%).
 * @property bool $max Adds a grayscale effect to an element (grayscale: 100%).
 *
...
class Grayscale extends PrefixedAttributeCollection
{
        ...
        {
                parent::__construct('grayscale', $props);
        }
