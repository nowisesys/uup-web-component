...
/**
 * Border bottom left CSS style.
 *
 * @property string $radius Defines the shape of the border of the bottom-left corner (since CSS3).<br><br>
 *      <b>CSS Syntax</b>
...
class Left extends PrefixedAttributeCollection
{
        ...
        {
                parent::__construct('border-bottom-left', $attrs);
        }
