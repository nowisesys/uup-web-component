 ...
 * @property string $async Specifies that the script is executed asynchronously (only for external scripts). Applies to <script>.
 * @property string $autocomplete Specifies whether the <form> or the <input> element should have autocomplete enabled. Applies to <form>, <input>.
 * @property string $autofocus Specifies that the element should automatically get focus when the page loads. Applies to <button>, <input>, <select>, <textarea>.
 * @property string $autoplay Specifies that the audio/video will start playing as soon as it is ready. Applies to <audio>, <video>.
 ...
 * @property string $checked Specifies that an <input> element should be pre-selected when the page loads (for type="checkbox" or type="radio"). Applies to <input>.
 ...
 * @property string $contenteditable Specifies whether the content of an element is editable or not. Applies to Global Attributes.
 ...
 * @property string $controls Specifies that audio/video controls should be displayed (such as a play/pause button etc). Applies to <audio>, <video>.
 ...
 * @property string $default Specifies that the track is to be enabled if the user's preferences do not indicate that another track would be more appropriate. Applies to <track>.
 * @property string $defer Specifies that the script is executed when the page has finished parsing (only for external scripts). Applies to <script>.
 ...
 * @property string $disabled Specifies that the specified element/group of elements should be disabled. Applies to <button>, <fieldset>, <input>, <optgroup>, <option>, <select>, <textarea>.
 * @property string $download Specifies that the target will be downloaded when a user clicks on the hyperlink. Applies to <a>, <area>.
 * @property string $draggable Specifies whether an element is draggable or not. Applies to Global Attributes.
 * @property string $dropzone Specifies whether the dragged data is copied, moved, or linked, when dropped. Applies to Global Attributes.
 ...
 * @property string $hidden Specifies that an element is not yet, or is no longer, relevant. Applies to Global Attributes.
 ...
 * @property string $ismap Specifies an image as a server-side image-map. Applies to <img>.
 ...
 * @property string $loop Specifies that the audio/video will start over again, every time it is finished. Applies to <audio>, <video>.
 ...
 * @property string $multiple Specifies that a user can enter more than one value. Applies to <input>, <select>.
 * @property string $muted Specifies that the audio output of the video should be muted. Applies to <video>, <audio>.
 ...
 * @property string $novalidate Specifies that the form should not be validated when submitted. Applies to <form>.
 * @property string $open Specifies that the details should be visible (open) to the user. Applies to <details>.
 ...
 * @property string $preload Specifies if and how the author thinks the audio/video should be loaded when the page loads. Applies to <audio>, <video>.
 * @property string $readonly Specifies that the element is read-only. Applies to <input>, <textarea>.
 ...
 * @property string $required Specifies that the element must be filled out before submitting the form. Applies to <input>, <select>, <textarea>.
 * @property string $reversed Specifies that the list order should be descending (9,8,7...). Applies to <ol>.
 ...
 * @property string $sandbox Enables an extra set of restrictions for the content in an <iframe>. Applies to <iframe>.
 ...
 * @property string $scoped Specifies that the styles only apply to this element's parent element and that element's child elements. Applies to <style>.
 * @property string $selected Specifies that an option should be pre-selected when the page loads. Applies to <option>.
 ...
 * @property string $spellcheck Specifies whether the element is to have its spelling and grammar checked or not. Applies to Global Attributes.
 ...
 * @property string $translate Specifies whether the content of an element should be translated or not. Applies to Global Attributes.
